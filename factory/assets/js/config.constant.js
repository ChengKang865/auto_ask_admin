...
//var AUTOASK_HOST = 'localhost:8080/autoask';
...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        //-----------------本店信息---------------------------------------------------
        'factoryDetailCtrl': 'assets/js/controllers/factory/factoryDetailCtrl.js',
        'factoryModifyCtrl': 'assets/js/controllers/factory/factoryModifyCtrl.js',
        'invoiceDetailCtrl': 'assets/js/controllers/factory/invoiceDetailCtrl.js',
        'invoiceModifyCtrl': 'assets/js/controllers/factory/invoiceModifyCtrl.js',
        'bindQRCodeDetailCtrl': 'assets/js/controllers/factory/bindQRCodeDetailCtrl.js',
        'bindQRCodeModifyCtrl': 'assets/js/controllers/factory/bindQRCodeModifyCtrl.js',
        //------------------订单------------------------------------------------------
