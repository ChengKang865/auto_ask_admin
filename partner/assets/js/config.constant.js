...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        //本店信息更改
        'partnerDetailCtrl': 'assets/js/controllers/partner/partnerDetailCtrl.js',
        'partnerModifyCtrl': 'assets/js/controllers/partner/partnerModifyCtrl.js',
        'invoiceDetailCtrl': 'assets/js/controllers/partner/invoiceDetailCtrl.js',
        'invoiceModifyCtrl': 'assets/js/controllers/partner/invoiceModifyCtrl.js',
        'modifyPasswordCtrl': 'assets/js/controllers/account/modifyPasswordCtrl.js',
        'bindQRCodeDetailCtrl': 'assets/js/controllers/partner/bindQRCodeDetailCtrl.js',
        'bindQRCodeModifyCtrl': 'assets/js/controllers/partner/bindQRCodeModifyCtrl.js',
