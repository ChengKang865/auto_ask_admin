 ...
 * 线下预约订单列表页面控制器
 */
app.controller('orderListCtrl', function ($scope, $rootScope, autoaskService, ngTableParams) {
    // 初始化方法
    $scope.init = function () {
        //查询条件初始化
        $scope.criteria = {
    ...
    $scope.tableParams = new ngTableParams({
        ...
        getData: function ($defer, params) {
            ...
            $scope.loadingPromise = autoaskService.getOrderList($scope.criteria, function (resp) {
