 ...
 * 列表页面控制器
 */
app.controller('serviceProviderListCtrl', function ($scope, $rootScope, autoaskService, ngTableParams, $state, $q) {
    $scope.total = 0;
    ...
    // 导出cvs
    $scope.filename = "serviceProvider";
