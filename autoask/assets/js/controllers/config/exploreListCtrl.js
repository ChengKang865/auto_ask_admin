app.controller("exploreListCtrl", ["$scope", "autoaskService", "ngTableParams", function ($scope, autoaskService, ngTableParams) {
    $scope.init = function () {
        //查询条件
        $scope.criteria = {};
    ...
    $scope.tableParams = new ngTableParams({
        ...
        getData: function ($defer, params) {
            $scope.loadingPromise = autoaskService.getExploreList($scope.criteria, function (resp) {
